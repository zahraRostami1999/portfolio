...
const HomePage = () => {
    return (
        <>
            <div className="w-full py-20 min-h-screen flex flex-wrap items-center">
                <div className="lg:px-8">
                    <div className="w-full flex lg:justify-between sm:flex-wrap-reverse justify-center flex-wrap-reverse">
                        ...
                        <div className="lg:w-2/5 md:w-2/5 sm:w-4/5 w-4/5 flex justify-center items-center md:items-center">
